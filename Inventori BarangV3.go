...
func main() {
	...
	case 1:
		...
		PencatatanBarangdanTransaksi(a, b, c, arrayjumlah, tambah)
	case 2:
	...
	case 4:
		...
		tampilarray(a, b, c, arrayjumlah, tambah)
		main()
	case 5:
...
func PencatatanBarangdanTransaksi(a tabBarang, b tabMasuk, c tabKeluar, arrayjumlah int, tambah int) {
	var menuInput int
	...
	case 2:
		...
		perubahanBarangdanTransaksi(a, b, c, arrayjumlah, tambah)
	case 3:
		fmt.Println("Penghapusan Data dan Transaksi...")
		penghapusanBarangdanTransaksi(a, b, c, arrayjumlah, tambah)
	case 4:
		main()
	}
}
...
func tampilarray(a tabBarang, b tabMasuk, c tabKeluar, arrayjumlah int, tambah int) {
	fmt.Println("Data Masuk:")
...
func perubahanBarangdanTransaksi(a tabBarang, b tabMasuk, c tabKeluar, arrayjumlah int, tambah int) {
	var menuInput int
	...
	switch menuInput {
	case 1:
		perubahantransaksidanbarang(a, b, c, arrayjumlah, tambah)
	case 2:
		perubahandata(a, b, c, arrayjumlah, tambah)
	case 3:
		perubahantransaki(a, b, c, arrayjumlah, tambah)
	case 4:
		PencatatanBarangdanTransaksi(a, b, c, arrayjumlah, tambah)
	}
}

func perubahantransaksidanbarang(a tabBarang, b tabMasuk, c tabKeluar, arrayjumlah int, tambah int) {
	var menuInput int
...
func perubahandata(a tabBarang, b tabMasuk, c tabKeluar, arrayjumlah int, tambah int) {
	var menuInput int
	fmt.Println("Data Sebelum Ubah:")
	tampilarray(a, b, c, arrayjumlah, tambah)
	fmt.Println("Urutan Ke berapa yang ingin di ubah?")
...
func perubahantransaki(a tabBarang, b tabMasuk, c tabKeluar, arrayjumlah int, tambah int) {
	var menuInput, x int
	fmt.Println("Data Sebelum Ubah:")
	tampilarray(a, b, c, arrayjumlah, tambah)
	fmt.Println("Urutan Ke berapa yang ingin di ubah?")
...
func penghapusanBarangdanTransaksi(a tabBarang, b tabMasuk, c tabKeluar, arrayjumlah int, tambah int) {
	var menuInput int
	...
	switch menuInput {
	case 1:
		penghapusantransaksidanbarang(a, b, c, arrayjumlah, tambah)
	case 2:
		penghapusandata(a, b, c, arrayjumlah, tambah)
	case 3:
		penghapusantransaki(a, b, c, arrayjumlah, tambah)
	case 4:
		PencatatanBarangdanTransaksi(a, b, c, arrayjumlah, tambah)
	}
}

func penghapusantransaksidanbarang(a tabBarang, b tabMasuk, c tabKeluar, arrayjumlah int, tambah int) {
	var menuInput int
...
func penghapusandata(a tabBarang, b tabMasuk, c tabKeluar, arrayjumlah int, tambah int) {
	var menuInput int
	fmt.Println("Data Sebelum Hapus:")
	tampilarray(a, b, c, arrayjumlah, tambah)
	fmt.Println("Urutan Ke berapa yang ingin di hapus?")
...
func penghapusantransaki(a tabBarang, b tabMasuk, c tabKeluar, arrayjumlah int, tambah int) {
	var menuInput, x int
	fmt.Println("Data Sebelum Hapus:")
	tampilarray(a, b, c, arrayjumlah, tambah)
	fmt.Println("Urutan Ke berapa yang ingin di hapus?")
